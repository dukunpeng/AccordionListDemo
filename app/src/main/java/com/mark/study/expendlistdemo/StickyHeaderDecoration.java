...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * Decide whether the item_preview_viewpgaer header should be shown. Default Rules:
     * 1. the first item_preview_viewpgaer header always should;
     * 2. if the item_preview_viewpgaer's header is different than last item_preview_viewpgaer, it should be shown, otherwise not.
     *
    ...
    private RecyclerView.ViewHolder getHeader(RecyclerView parent, int adapterPosition) {
        ...
        if (holder == null) {
            holder = mAdapter.onCreateHeaderViewHolder(parent,adapterPosition);
